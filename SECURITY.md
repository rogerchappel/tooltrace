...
Replace this section with the supported versions for `tooltrace`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `tooltrace` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in tooltrace.
